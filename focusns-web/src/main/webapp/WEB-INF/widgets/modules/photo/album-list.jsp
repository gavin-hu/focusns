            ...
            <c:otherwise>
                <ul class="thumbnails">
                    <c:forEach items="${albums}" var="album">
                        <li class="span3">
                            <div class="thumbnail">
                                <a href="<c:url value="/photo;p=${project.code},m=list,albumId=${album.id}" />">
                                    <c:choose>
                                ...
                                <div class="caption">
                                    ...
                                    <a class="btn-link" href="<c:url value="/photo/album;p=${project.code},m=edit,albumId=${album.id}" />">编辑</a>
                                    <a class="btn-link" href="<c:url value="/photo/photo;p=${project.code},m=edit,albumId=${album.id}" />">上传</a>
                                </div>
                            </div>
                        </li>
                    </c:forEach>
