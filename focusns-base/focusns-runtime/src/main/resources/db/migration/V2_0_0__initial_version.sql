...
-- TB_PROJECT_HISTROY
ALTER TABLE TB_PROJECT_HISTROY ADD CONSTRAINT FK_PARENT_ID_TB_PROJECT_HISTROY
    FOREIGN KEY(`PARENT_ID`)
    REFERENCES TB_PROJECT_HISTROY(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;

ALTER TABLE TB_PROJECT_HISTROY ADD CONSTRAINT FK_PROJECT_ID_TB_PROJECT_HISTROY
    FOREIGN KEY(`PROJECT_ID`)
    REFERENCES TB_PROJECT(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
