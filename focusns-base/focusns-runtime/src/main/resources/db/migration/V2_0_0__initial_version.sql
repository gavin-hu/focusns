...
CREATE TABLE TB_USER (
  ...
  PRIMARY KEY (`ID`) ,
  UNIQUE INDEX `EMAIL_UNIQUE` (`USERNAME`)
);
...
-- TB_USER_ROLE
ALTER TABLE TB_USER_ROLE ADD CONSTRAINT FK_USER_ID_TB_USER_ROLE
    FOREIGN KEY(`USER_ID`)
    REFERENCES TB_USER(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;

ALTER TABLE TB_USER_ROLE ADD CONSTRAINT FK_ROLE_ID_TB_USER_ROLE
    FOREIGN KEY(`ROLE_ID`)
    REFERENCES TB_ROLE(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;

ALTER TABLE TB_ROLE_AUTHORITY ADD CONSTRAINT FK_ROLE_ID_TB_ROLE_AUTHORITY
    FOREIGN KEY(`ROLE_ID`)
    REFERENCES TB_ROLE(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;

ALTER TABLE TB_ROLE_AUTHORITY ADD CONSTRAINT FK_AUTHORITY_ID_TB_ROLE_AUTHORITY
...
ALTER TABLE TB_PROJECT_HISTORY ADD CONSTRAINT FK_CREATE_BY_ID_TB_PROJECT_HISTORY
    FOREIGN KEY(`CREATE_BY_ID`)
    REFERENCES TB_PROJECT_USER(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
ALTER TABLE TB_BLOG_POST ADD CONSTRAINT FK_CREATE_BY_ID_TB_BLOG_POST
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ALTER TABLE TB_BLOG_POST ADD CONSTRAINT FK_MODIFY_BY_ID_TB_BLOG_POST
    FOREIGN KEY(`MODIFY_BY_ID`)
    REFERENCES TB_PROJECT_USER(`ID`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
