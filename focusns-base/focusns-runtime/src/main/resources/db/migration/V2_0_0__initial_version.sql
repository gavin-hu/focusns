...
CREATE TABLE TB_FORUM_CATEGORY(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_FORUM_CATEGORY FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`)
);
...
CREATE TABLE TB_FORUM_TOPIC (
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_FORUM_TOPIC FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`) ,
    CONSTRAINT FK_MODIFY_BY_ID_TB_FORUM_TOPIC FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_USER(`ID`)
);
...
CREATE TABLE TB_FORUM_POST (
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_FORUM_POST FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`) ,
    CONSTRAINT FK_MODIFY_BY_ID_TB_FORUM_POST FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_USER(`ID`)
);
...
CREATE TABLE TB_EVENT_CATEGORY(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_EVENT_CATEGORY FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`)
);
...
CREATE TABLE TB_EVENT(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_EVENT FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`) ,
    CONSTRAINT FK_MODIFY_BY_ID_TB_EVENT FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_USER(`ID`)
);
...
CREATE TABLE TB_ALBUM(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_ALBUM FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`)
);
...
CREATE TABLE TB_PHOTO(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_PHOTO FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_USER(`ID`)
);
