...
CREATE TABLE TB_PROJECT (
	...
	PRIMARY KEY (`ID`) , 
	UNIQUE INDEX `CODE_UNIQUE` (`CODE`) ,
	CONSTRAINT FK_CREATE_BY_ID_TB_PROJECT FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`) ,
	CONSTRAINT FK_MODIFY_BY_ID_TB_PROJECT FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`) ,
...
CREATE TABLE TB_PROJECT_HISTROY (
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_PROJECT_HISTROY FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_BLOG_CATEGORY (
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_BLOG_CATEGORY FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_BLOG_POST (
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_BLOG_POST FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_BLOG_COMMENT (
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_BLOG_COMMENT FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_FORUM_CATEGORY(
    ...
    `CREATE_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_FORUM_CATEGORY FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_FORUM_CATEGORY FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_FORUM_TOPIC (
    ...
    `MODIFY_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_FORUM_TOPIC FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_CATEGORY_ID_TB_FORUM_TOPIC FOREIGN KEY (`CATEGORY_ID`) REFERENCES TB_FORUM_CATEGORY(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_FORUM_TOPIC FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`) ,
    CONSTRAINT FK_MODIFY_BY_ID_TB_FORUM_TOPIC FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_FORUM_POST (
    ...
    `MODIFY_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_FORUM_POST FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_TOPIC_ID_TB_FORUM_POST FOREIGN KEY (`TOPIC_ID`) REFERENCES TB_FORUM_TOPIC(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_FORUM_POST FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`) ,
    CONSTRAINT FK_MODIFY_BY_ID_TB_FORUM_POST FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_EVENT_CATEGORY(
    ...
    `CREATE_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_EVENT_CATEGORY FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_EVENT_CATEGORY FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_EVENT(
    ...
    `MODIFY_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_CATEGORY_ID_TB_EVENT FOREIGN KEY (`CATEGORY_ID`) REFERENCES TB_EVENT_CATEGORY(`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_EVENT FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_EVENT FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`) ,
    CONSTRAINT FK_MODIFY_BY_ID_TB_EVENT FOREIGN KEY (`MODIFY_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_ALBUM(
    ...
    `CREATE_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_ALBUM FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_ALBUM FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_PHOTO(
    ...
    `CREATE_BY_ID` BIGINT NOT NULL ,
    PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_ALBUM_ID_TB_PHOTO FOREIGN KEY (`ALBUM_ID`) REFERENCES TB_ALBUM(`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_PHOTO FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`) ,
    CONSTRAINT FK_CREATE_BY_ID_TB_PHOTO FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_MESSAGE_BOX(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_MESSAGE_BOX FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
...
CREATE TABLE TB_MESSAGE(
    ...
    CONSTRAINT FK_CREATE_BY_ID_TB_MESSAGE FOREIGN KEY (`CREATE_BY_ID`) REFERENCES TB_PROJECT_USER(`ID`)
);
