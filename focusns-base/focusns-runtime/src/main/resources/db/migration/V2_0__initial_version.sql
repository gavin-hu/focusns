...
CREATE TABLE TB_BLOG_TAG (
    ...
    `PROJECT_ID` BIGINT NOT NULL ,
	PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_PROJECT_ID_TB_BLOG_TAG FOREIGN KEY (`PROJECT_ID`) REFERENCES TB_PROJECT(`ID`)
);
...
CREATE TABLE TB_BLOG_POST (
    ...
    `CREATE_BY_ID` BIGINT NOT NULL ,
	PRIMARY KEY (`ID`) ,
    CONSTRAINT FK_TAG_ID_TB_BLOG_POST FOREIGN KEY (`TAG_ID`) REFERENCES TB_BLOG_TAG(`ID`) ,
